...
### Backend
NestJS app using module/controller/service pattern with TypeORM entities. Modules: auth, ad-spending, income, leads, dashboard. JWT authentication with bcrypt passwords. All data is user-scoped via userId FK.
